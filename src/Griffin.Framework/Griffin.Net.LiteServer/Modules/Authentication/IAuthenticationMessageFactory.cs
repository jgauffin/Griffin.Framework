...
namespace Griffin.Net.LiteServer.Modules.Authentication
{
    ...
    public interface IAuthenticationMessageFactory
    {
        ...
        /// </returns>
        IClientPreAuthentication CreateClientPreAuthentication(string userName);
        ...
        /// <remarks>
        /// <para>You are responsible of generating the session salt. You can for instance do that by using <see cref="PasswordHasher.CreateSalt"/>.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <returns>message that can be serialized</returns>
        IClientAuthentication CreateClientAuthentication(string token);
        ...
        /// <returns>message that can be serialized</returns>
        IAuthenticationResult CreateAuthenticationResult(AuthenticationResultState state);
    }
}