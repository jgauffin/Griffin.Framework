...
namespace Griffin.Cqs.Http
{
    ...
    public class CqsHttpClient : IRequestReplyBus, ICommandBus, IQueryBus, IEventBus
    {
        ...
        private static async Task<object> DeserializeBody(HttpWebResponse response)
        {
