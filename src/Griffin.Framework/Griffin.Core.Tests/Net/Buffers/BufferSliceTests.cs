...
namespace Griffin.Core.Tests.Net.Buffers
{
    public class BufferSliceTests
    {
        ...
        //    var sut = new BufferSlice(buffer, 5, 5);
        ...
        //    var destination = new BufferSlice(new byte[20], 0, 20);
        ...
        //{
        //    var buffer = Encoding.ASCII.GetBytes("Hello world");
        //    var slice = new BufferSlice(new byte[20], 0, 20);
        ...
        //{
        //    var buffer = Encoding.ASCII.GetBytes("Hello world");
        //    var destination = new BufferSlice(new byte[20], 0, 0);
