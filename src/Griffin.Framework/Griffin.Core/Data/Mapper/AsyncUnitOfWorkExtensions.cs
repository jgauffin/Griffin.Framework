...
namespace Griffin.Data.Mapper
{
    ...
    public static class AsyncAdoNetUnitOfWorkExtensions
    {
        ...
        /// <remarks>
        ///     <para>
        ///         Uses <see cref="EntityMappingProvider" /> to find the correct <c><![CDATA[ICrudEntityMapper<TEntity>]]></c>
        ///     </para>
        /// </remarks>
        /// <example>
        ///     <code>
        ...
        /// </example>
        /// <exception cref="EntityNotFoundException">Failed to find an entity mathing the query</exception>
        public static Task<TEntity> FirstAsync<TEntity>(this IAdoNetUnitOfWork unitOfWork, string query,
            object parameters)
        {
            if (unitOfWork == null) throw new ArgumentNullException("unitOfWork");
        ...
        /// </code>
        /// </example>
        public static Task<TEntity> FirstOrDefaultAsync<TEntity>(this IAdoNetUnitOfWork unitOfWork, string query,
        ...
        /// </code>
        /// </example>
        public static Task<IEnumerable<TEntity>> ToEnumerableAsync<TEntity>(this IAdoNetUnitOfWork unitOfWork,
        ...
        /// </code>
        /// </example>
        public static async Task<List<TEntity>> ToListAsync<TEntity>(this IAdoNetUnitOfWork unitOfWork, string query,
            params object[] parameters)
        {
            if (unitOfWork == null) throw new ArgumentNullException("unitOfWork");
            if (query == null) throw new ArgumentNullException("query");
