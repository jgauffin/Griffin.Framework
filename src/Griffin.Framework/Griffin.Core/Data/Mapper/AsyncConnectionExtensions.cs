...
namespace Griffin.Data.Mapper
{
    ...
    public static class AsyncConnectionExtensions
    {
        ...
        /// </code>
        /// </example>
        public static async Task ExecuteNonQueryAsync(this IDbConnection connection, string sql,
        ...
        /// </code>
        /// </example>
        public static Task<TEntity> FirstOrDefaultAsync<TEntity>(this IDbConnection connection, string query,
            params object[] parameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        /// </code>
        /// </example>
        public static Task<IEnumerable<TEntity>> ToEnumerableAsync<TEntity>(this IDbConnection connection, string query,
            params object[] parameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        /// </code>
        /// </example>
        public static async Task<List<TEntity>> ToListAsync<TEntity>(this IDbConnection connection, string query,
            params object[] parameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
